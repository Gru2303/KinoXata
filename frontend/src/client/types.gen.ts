...
export type PlaceOrderResponseTransformer = (data: any) => Promise<PlaceOrderResponse>
...
export const PlaceOrderResponseTransformer: PlaceOrderResponseTransformer = async (data) => {
